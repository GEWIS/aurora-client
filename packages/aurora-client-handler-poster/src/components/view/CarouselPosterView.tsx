import './../../index.scss';
import './carouselPosterView.scss';
import { useEffect, useState } from 'react';
import { getPosters, getPosterSettings, Poster, PosterScreenSettingsResponse } from '@gewis/aurora-client-api';
import { HandlerComponent } from '@gewis/aurora-client-util';
import PosterCarousel from '../base/Carousel';
import ProgressBar from '../base/ProgressBar';
import { URL_PROGRESS_BAR_LOGO } from '../helpers/constants';
import Logo from '../../../assets/base/poster-background.png'

export const CarouselPosterView: HandlerComponent = () => {
