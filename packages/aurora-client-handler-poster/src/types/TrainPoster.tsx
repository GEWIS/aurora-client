...
import { getTrains, TrainResponse } from '@gewis/aurora-client-api';
import './trainPoster.scss';
import { VerticalScroll } from '@gewis/aurora-client-theme';
import Trains from '../../assets/trains/train.svg?react'
import NS from '../../assets/trains/NS.svg?react'
            ...
            <div className="flex flex-col justify-start">
              <div>
                <span className="italic">
                  <NS className="inline-block" /> {t.trainType}
                </span>{' '}
    ...
    >
      <VerticalScroll visible={visible} timeout={timeout} items={trains ? trains.length : 0}>
        <div className="py-10 px-20">
          ...
          >
            <Trains className="align-bottom mb-2 h-32" />
            <div>Departures from Eindhoven Centraal</div>
            <Trains className="align-bottom mb-2 h-32" style={{ transform: 'scaleX(-1)' }} />
          </div>
