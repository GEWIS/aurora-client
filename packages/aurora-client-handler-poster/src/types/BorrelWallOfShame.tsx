...
import { getSudoSosWallOfShame, SudoSosDebtorResponse } from '@gewis/aurora-client-api';
import { VerticalScroll } from '@gewis/aurora-client-theme';
import { bacShadow, redShadow } from '../helpers/shadows';
import shame from '../../assets/borrel/shame.gif';
...
export default function BorrelWallOfShamePoster({ visible }: Props) {
  ...
  return (
    <div
      ...
      style={{
        background: `url("${shame}") no-repeat center center fixed`,
