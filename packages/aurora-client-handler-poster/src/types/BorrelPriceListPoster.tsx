...
import { getSudoSosPriceList, ProductCategoryResponse, ProductResponse } from '@gewis/aurora-client-api';
...
export default function BorrelPriceListPoster({ visible }: Props) {
  ...
  return (
    <div
      className="h-full w-full px-20 py-16 text-5xl text-white overflow-hidden bg-cover"
      style={{
